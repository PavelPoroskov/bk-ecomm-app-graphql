...
async function seedDatabase() {
  ...
  await PostModel.create(
    createPostListByUserOne(1),
  );
  await waitSec(3);
  await PostModel.create(
    createPostListByUserTwo(1),
  );

  await waitSec(2);
  await PostModel.create(
    createPostListByUserOne(2),
  );
  await waitSec(3);
  await PostModel.create(
    createPostListByUserTwo(2),
  );

  await waitSec(2);
  await PostModel.create(
    createPostListByUserOne(3),
  );
  await waitSec(3);
  await PostModel.create(
    createPostListByUserTwo(3),
  );

  await waitSec(2);
  await PostModel.create(
    createPostListByUserOne(4),
  );
  await waitSec(3);
  await PostModel.create(
    createPostListByUserTwo(4),
  );
}
